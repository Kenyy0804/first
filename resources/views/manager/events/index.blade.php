            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-4 mx-auto">
                      ...
                      <div class="flex">
                        <div class="mr-10">
                      <button onclick="location.href='{{ route('events.past') }}'" class="flex mb-4 ml-auto text-white bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">過去のイベント一覧</button>
                      </div>

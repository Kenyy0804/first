        ...
        <div class="w-32">
            ...
            @for($j = 0; $j < 21; $j++)
                @if($events->isNotEmpty())
                    ...
                    <div class="py-1 px-2 h-8 border border-gray-200 text-xs bg-blue-300">
                        {{ $eventName }}</div>
                        </a>
                        @if ($eventPeriod > 0)
                            @for ($k = 0; $k < $eventPeriod ; $k++)
                            <div class="py-1 px-2 h-8 border border-gray-200 bg-blue-300"></div>
                            @endfor
